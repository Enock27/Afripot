...
**Opening**:
- "Reserve a table" button in bottom-right corner triggers sidebar
...
2. `src/components/FixedReservationButton.tsx` - Button to trigger sidebar
3. `src/styles.css` - Added sidebar animations
...
### For Users
1. Click "Reserve a table" button (bottom-right corner)
